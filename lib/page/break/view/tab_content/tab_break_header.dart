...
class TabBreakHeader extends StatelessWidget {
  final CustomTimerController timerController;
  final DashboardModel? dashboardModel;

  const TabBreakHeader(
    ...
    return Column(
      children: [
            ...
            child: Text.rich(
              TextSpan(
                children: [
                  ...
                  TextSpan(
                      text: 'break'.tr(),
                      style:  TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: const Color(0xFF555555))),
                ],
              ),
            ),
          ),
        ...
        Visibility(
          ...
          child: Text("you_have_not_taken_a_break",
            style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp,color: const Color(0xFF555555))).tr(),
        ),
