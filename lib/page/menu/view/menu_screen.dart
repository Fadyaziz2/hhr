    ...
    return BlocProvider(
        ...
        child: Scaffold(key: MenuScreen._scaffoldKey, endDrawer: const MenuDrawer(), extendBody: true,
            body: BlocBuilder<LanguageBloc, LanguageState>(builder: (context, state) {
              return Container(decoration: const BoxDecoration(gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [colorPrimary, colorPrimaryGradient])),
                  ...
                  child: Column(
                    children: [
                            ...
                            child: Row(
                              children: [
                                ...
                                IconButton(
                                    ...
                                    icon: Icon(Icons.menu, color: colorPrimary, size: 25.r,))
                              ],
                            ),
                          ),
                        ),
                      ...
                      /// Menu List
                      MenuList(animationController: animationController,),
