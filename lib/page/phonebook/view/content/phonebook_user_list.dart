            ...
            itemBuilder: (BuildContext context, int index) {
              return InkWell(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    title: Text(state.phonebook?.data?.users?[index].name ?? ""),
                    subtitle: Text(state.phonebook?.data?.users?[index].designation ?? ""),
                    leading: ClipOval(
                      child: CachedNetworkImage(
                        height: 40,
                        width: 40,
                        fit: BoxFit.cover,
                        imageUrl: "${state.phonebook?.data?.users?[index].avatar}",
