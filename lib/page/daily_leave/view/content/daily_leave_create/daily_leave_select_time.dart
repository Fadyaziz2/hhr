  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        leading:  Icon(Icons.access_time_outlined, size: 22.r),
        title: Text(
            context.watch<DailyLeaveBloc>().state.approxTime ?? 'time'.tr(),  style: Theme.of(context).textTheme.titleMedium),
        trailing: Icon(Icons.keyboard_arrow_down_sharp, size: 25.r,),
      ),
    );
  }
}
