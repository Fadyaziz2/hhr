...
class LeaveRequestType extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(create: (context) => LeaveBloc(metaClubApiClient: MetaClubApiClient(token: "${user?.user?.token}"))
              ...
              bottomNavigationBar: Container(
                ...
                child: Padding(
                  ...
                  child: CustomButton(
                    ...
                    padding: 16,
                    clickButton: () {
                      NavUtil.navigateScreen(context, const LeaveCalendar(leaveRequestTypeId: 3,));
                    },
                  ),
                ),
              ),
